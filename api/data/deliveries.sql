...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-07-2022 a las 07:34:30
...
CREATE TABLE `orders` (
  ...
  `active_order` tinyint(1) NOT NULL DEFAULT 0,
...
(1, 1, 1, '2022-07-06', 1, 2, 3, 0, '2022-05-06 16:02:01', '2022-07-07 23:51:58'),
(2, 1, 2, '2022-07-06', 1, 2, 3, 0, '2022-06-06 16:02:01', '2022-07-07 23:52:06'),
(3, 2, 1, '2022-07-06', 2, 4, 6, 0, '2022-06-06 16:02:52', '2022-07-07 23:52:19'),
(4, 2, 2, '2022-07-06', 1, 3, 5, 0, '2022-07-06 16:02:52', '2022-07-06 16:03:26'),
(5, 3, 3, '2022-06-05', 1, 2, 3, 0, '2022-07-06 00:55:13', '2022-07-08 00:55:42');
...
CREATE TABLE `products` (
  ...
  `active_product` tinyint(1) DEFAULT 0,
...
(1, 1, 'gamepadAltra', 'gamepad', NULL, 100, 1500, 1, '2022-07-06 15:56:04', '2022-07-12 02:46:20'),
(2, 3, 'teclado', 'teclado', NULL, 100, 25, 0, '2022-07-05 15:56:04', '2022-07-06 16:00:33'),
(3, 2, 'raton', 'raton', NULL, 12, 15, 1, '2022-07-05 20:41:07', '2022-07-10 23:12:04'),
(4, 3, 'laptop', 'laptop', NULL, 100, 1500, 0, '2022-07-06 15:56:04', '2022-07-07 23:05:09'),
(5, 2, 'teclado', 'teclado', NULL, 100, 25, 1, '2022-07-05 15:56:04', '2022-07-10 23:12:10'),
(6, 1, 'raton', 'raton', NULL, 12, 15, 0, '2022-07-05 20:41:07', '2022-07-07 22:24:08');
...
CREATE TABLE `users` (
  ...
  `activation_code_user` tinyint(1) DEFAULT 0,
  `active_user` tinyint(1) DEFAULT 0,
  `logged_in_user` tinyint(1) DEFAULT 0,
...
(2, 'luc', 'umy', NULL, 'lucumy@gmail.com', 'lucumy', '123456789', 127, NULL, NULL, NULL, NULL, '2022-07-05 15:54:32', '2022-07-06 15:55:56'),
